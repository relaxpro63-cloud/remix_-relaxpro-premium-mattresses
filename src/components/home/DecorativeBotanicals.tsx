...
export default function DecorativeBotanicals({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute -top-[5%] -left-[6%] w-[360px] opacity-[0.35]"
        animate={{
          y: [0, -10, 0],
          rotate: [-16, -12, -16],
        }}
      ...
      <motion.div
        className="absolute top-[35%] -left-[8%] w-[280px] opacity-[0.35]"
        animate={{
          y: [0, 8, 0],
          rotate: [-8, -4, -8],
        }}
      ...
      <motion.div
        className="absolute bottom-[5%] -left-[5%] w-[240px] opacity-[0.35]"
        animate={{
          y: [0, -6, 0],
          rotate: [5, 8, 5],
        }}
      ...
      <motion.div
        className="absolute -top-[3%] -right-[6%] w-[380px] opacity-[0.35]"
        animate={{
          y: [0, -8, 0],
          rotate: [12, 16, 12],
        }}
      ...
      <motion.div
        className="absolute top-[45%] -right-[7%] w-[260px] opacity-[0.35]"
        animate={{
          y: [0, 6, 0],
          rotate: [-10, -6, -10],
        }}
      ...
      {density === 'full' && (
        <motion.div
          className="absolute bottom-[8%] -right-[4%] w-[200px] opacity-[0.35]"
          animate={{
            y: [0, -5, 0],
            rotate: [-5, -2, -5],
          }}
      ...
      <motion.div
        className="absolute top-[15%] right-[12%] w-[60px] opacity-[0.35]"
      ...
      <motion.div
        className="absolute bottom-[20%] left-[15%] w-[40px] opacity-[0.35]"
