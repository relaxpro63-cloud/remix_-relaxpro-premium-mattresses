...
function LeafLarge({ className, grad }: { className?: string; grad: GradFn }) {
  return (
    <svg viewBox="0 0 400 500" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id={grad('leafLg')} x1="0" y1="0" x2="1" y2="1">
      ...
      {/* Stem */}
      <path d="M200 470 C200 420 195 350 200 300 C205 250 198 200 200 160" stroke={`url(#${grad('leafLg')})`} strokeWidth="3" strokeLinecap="round" fill="none" />
      {/* Left lobe */}
      <path d="M200 160 C180 140 130 130 100 150 C70 170 60 210 80 240 C100 270 140 280 170 260 C190 248 198 220 200 200" fill={`url(#${grad('leafLg')})`} />
      {/* Right lobe */}
      <path d="M200 160 C220 135 270 125 300 145 C330 165 340 205 320 235 C300 265 260 275 230 255 C210 243 202 215 200 195" fill={`url(#${grad('leafLg')})`} />
      {/* Top lobe */}
      <path d="M200 160 C190 130 175 100 190 80 C205 60 215 65 220 85 C225 105 210 135 200 160" fill={`url(#${grad('leafLg')})`} />
      {/* Center vein */}
      <path d="M200 160 C198 200 202 250 200 300" stroke={`url(#${grad('leafLg')})`} strokeWidth="1.5" strokeLinecap="round" fill="none" />
      {/* Side veins */}
      <path d="M200 200 C180 195 155 190 140 195" stroke={`url(#${grad('leafLg')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      <path d="M200 200 C220 195 245 190 260 195" stroke={`url(#${grad('leafLg')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      <path d="M200 240 C175 235 145 235 125 245" stroke={`url(#${grad('leafLg')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      <path d="M200 240 C225 235 255 235 275 245" stroke={`url(#${grad('leafLg')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
function LeafMedium({ className, grad }: { className?: string; grad: GradFn }) {
  return (
    <svg viewBox="0 0 300 400" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id={grad('leafMed')} x1="0" y1="0" x2="1" y2="1">
        ...
        <linearGradient id={grad('leafMed2')} x1="1" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#4F7E6A" stopOpacity="0.55" />
          <stop offset="100%" stopColor="#A8C99A" stopOpacity="0.28" />
        </linearGradient>
      </defs>
      {/* Main stem */}
      <path d="M150 380 C145 320 140 260 150 200 C160 140 155 80 150 40" stroke={`url(#${grad('leafMed')})`} strokeWidth="2.5" strokeLinecap="round" fill="none" />
      {/* Leaf 1 — left */}
      <path d="M150 320 C120 300 90 310 80 330 C70 350 95 365 120 355 C135 348 145 335 150 325" fill={`url(#${grad('leafMed')})`} />
      <path d="M150 320 C130 310 105 315 95 330" stroke={`url(#${grad('leafMed')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      {/* Leaf 2 — right */}
      <path d="M148 270 C178 248 210 255 220 275 C230 295 205 310 180 300 C165 293 153 280 148 272" fill={`url(#${grad('leafMed2')})`} />
      <path d="M148 270 C170 255 200 260 210 275" stroke={`url(#${grad('leafMed2')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      {/* Leaf 3 — left lower */}
      <path d="M152 220 C125 200 95 205 85 225 C75 245 100 260 120 250 C135 243 147 232 152 222" fill={`url(#${grad('leafMed')})`} />
      <path d="M152 220 C130 208 105 212 95 225" stroke={`url(#${grad('leafMed')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      {/* Leaf 4 — right upper */}
      <path d="M147 160 C175 140 205 148 212 168 C219 188 198 200 178 190 C162 183 150 172 147 162" fill={`url(#${grad('leafMed2')})`} />
      <path d="M147 160 C168 145 195 152 205 168" stroke={`url(#${grad('leafMed2')})`} strokeWidth="1" strokeLinecap="round" fill="none" />
      {/* Top bud */}
      <ellipse cx="150" cy="45" rx="12" ry="18" fill={`url(#${grad('leafMed')})`} transform="rotate(-15 150 45)" />
    </svg>
  );
}
...
function LeafSmall({ className, grad }: { className?: string; grad: GradFn }) {
  return (
    <svg viewBox="0 0 200 280" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      {/* Stem */}
      <path d="M100 260 C98 220 102 180 100 140 C98 100 102 60 100 30" stroke={`url(#${grad('leafSm')})`} strokeWidth="2" strokeLinecap="round" fill="none" />
      {/* Leaf body — elegant teardrop */}
      <path d="M100 140 C70 120 40 90 50 65 C60 40 80 35 100 30 C120 35 140 40 150 65 C160 90 130 120 100 140Z" fill={`url(#${grad('leafSm')})`} />
      {/* Center vein */}
      <path d="M100 140 C100 100 100 70 100 30" stroke={`url(#${grad('leafSm')})`} strokeWidth="1.2" strokeLinecap="round" fill="none" />
      {/* Side veins */}
      <path d="M100 110 C85 105 72 100 65 95" stroke={`url(#${grad('leafSm')})`} strokeWidth="0.8" strokeLinecap="round" fill="none" />
      <path d="M100 110 C115 105 128 100 135 95" stroke={`url(#${grad('leafSm')})`} strokeWidth="0.8" strokeLinecap="round" fill="none" />
      <path d="M100 80 C88 76 78 72 72 68" stroke={`url(#${grad('leafSm')})`} strokeWidth="0.8" strokeLinecap="round" fill="none" />
      <path d="M100 80 C112 76 122 72 128 68" stroke={`url(#${grad('leafSm')})`} strokeWidth="0.8" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
function VineAccent({ className, grad }: { className?: string; grad: GradFn }) {
  return (
    <svg viewBox="0 0 120 160" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id={grad('vine')} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#4F7E6A" stopOpacity="0.50" />
          <stop offset="100%" stopColor="#A8C99A" stopOpacity="0.28" />
        </linearGradient>
      </defs>
      {/* Flowing vine */}
      <path d="M10 150 C20 120 40 110 60 120 C80 130 100 115 110 90 C115 78 112 60 105 45" stroke={`url(#${grad('vine')})`} strokeWidth="2" strokeLinecap="round" fill="none" />
      {/* Small leaf on vine */}
      <path d="M60 120 C45 110 35 100 40 88 C45 76 58 78 65 90 C70 98 67 110 60 120Z" fill={`url(#${grad('vine')})`} />
      <path d="M60 120 C55 108 52 98 55 90" stroke={`url(#${grad('vine')})`} strokeWidth="0.8" strokeLinecap="round" fill="none" />
      {/* Another small leaf */}
      <path d="M95 105 C82 98 72 88 78 76 C84 64 96 68 102 80 C106 88 102 98 95 105Z" fill={`url(#${grad('vine')})`} />
      <path d="M95 105 C90 94 88 85 90 80" stroke={`url(#${grad('vine')})`} strokeWidth="0.8" strokeLinecap="round" fill="none" />
    </svg>
  );
}
