...
export default {
  ...
  fields: [
    ...
    { name: 'ourStory', title: 'Our Story', type: 'object', fields: [{ name: 'title', title: 'Section Title', type: 'string' }, { name: 'content', title: 'Story Content', type: 'array', of: [{ type: 'block' }, imageMember] }] },
    ...
    { name: 'teamSection', title: 'Team / Factory Section', type: 'object', fields: [{ name: 'title', title: 'Section Title', type: 'string' }, { name: 'content', title: 'Content', type: 'array', of: [{ type: 'block' }, imageMember] }] },
