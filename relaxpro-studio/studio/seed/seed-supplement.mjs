...
async function seedBuilderMaterials() {
  ...
  const materials = [
    ...
    { _id: 'mat-rebonded-firm', name: 'Rebonded Foam (Firm Support)', slug: { current: 'rebonded-foam' }, slot: 'support', brand: 'Century Foam', density: '90-95 Density', ild: 'ILD-45', feelTag: 'Rigid, orthopedic support', benefit: 'High density rebonded foam for maximum structural support. Ideal for the base layer of your mattress.', tooltip: 'Century brand rebonded foam. 90-95 Density. ILD 45. Zero sagging guarantee. 10+ year lifespan.', thicknessOptions: [{ _key: 't1', inches: 2, addPrice: 1500 }, { _key: 't2', inches: 3, addPrice: 2250 }, { _key: 't3', inches: 4, addPrice: 3000 }, { _key: 't4', inches: 5, addPrice: 3750 }, { _key: 't5', inches: 6, addPrice: 4500 }], stackColor: '#D4C5A9', image: null, isRecommended: true, order: 4, isActive: true },
    { _id: 'mat-hr-softy', name: 'HR Softy Foam (Cushioning)', slug: { current: 'hr-softy-foam' }, slot: 'support', brand: 'Century AirFlow', density: '40-50 Density', ild: 'ILD-18', feelTag: 'Soft, plush transition layer', benefit: 'High resilience softy foam that provides a gentle transition between firm support and latex comfort layers.', tooltip: 'Century HR Softy Foam. 40-50 Density. ILD 18. High resilience — bounces back instantly. Great for pressure relief.', thicknessOptions: [{ _key: 't1', inches: 1, addPrice: 800 }, { _key: 't2', inches: 2, addPrice: 1600 }], stackColor: '#F0E6D3', image: null, isRecommended: false, order: 5, isActive: true },
    { _id: 'mat-latex-rebonded', name: 'Latex Rebonded Core (Eco)', slug: { current: 'latex-rebonded-core' }, slot: 'support', brand: 'RelaxPro Eco Core', density: '120 Density', ild: 'ILD-40', feelTag: 'Dense, eco-friendly support', benefit: 'Made from upcycled organic latex shreds compressed into a high-density core. Eco-friendly without compromising on support.', tooltip: '120 Density Latex Rebonded. ILD 40. Made from upcycled GOLS latex shreds. Eco-Institut certified. Zero waste manufacturing.', thicknessOptions: [{ _key: 't1', inches: 2, addPrice: 2500 }, { _key: 't2', inches: 3, addPrice: 3750 }, { _key: 't3', inches: 4, addPrice: 5000 }], stackColor: '#A8C8A8', image: null, isRecommended: false, order: 6, isActive: true },
  ]
...
function seedBuilderConfig() {
  ...
  return {
    ...
    defaults: { sizeName: 'Queen', comfortMaterialSlug: 'pure-natural-latex-medium', comfortThickness: 2, supportMaterialSlug: 'rebonded-foam', supportThickness: 4, coverFabricSlug: 'fabric-300gsm', quiltingSlug: 'quilting-8mm' },
