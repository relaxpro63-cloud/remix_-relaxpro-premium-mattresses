...
async function seedBuilderMaterials() {
  console.log('\n═══════ BUILDER MATERIALS ═══════')
  const materials = [
    { _id: 'mat-pure-latex-2', name: 'Pure Natural Latex (Soft)', slug: { current: 'pure-natural-latex-soft' }, slot: 'comfort', brand: 'RelaxPro Kerala Organic', density: '80 Density', ild: 'ILD-22', feelTag: 'Soft, hugging feel', benefit: 'GOLS certified pure latex with a soft, plush feel. Ideal for pressure relief and side sleepers.', tooltip: '80 Density Pure Dunlop Latex. ILD 22. GOLS certified organic. Very responsive — zero sinking feeling.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 2000 }, { _key: 't2', label: '3"', valueInches: 3, addPrice: 3000 }, { _key: 't3', label: '4"', valueInches: 4, addPrice: 4000 }], stackColor: '#E8D5B7', image: null, isRecommended: false, order: 1, isActive: false },
    { _id: 'mat-pure-latex-4', name: 'Pure Natural Latex (Medium)', slug: { current: 'pure-natural-latex-medium' }, slot: 'comfort', brand: 'RelaxPro Kerala Organic', density: '90 Density', ild: 'ILD-28', feelTag: 'Balanced, responsive comfort', benefit: 'Our most popular comfort layer. GOLS certified 90 density latex offering the perfect balance of contouring and support.', tooltip: '90 Density Pure Dunlop Latex. ILD 28. GOLS certified. Open-cell structure for cooling. 96.6% purity.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 2500 }, { _key: 't2', label: '3"', valueInches: 3, addPrice: 3750 }, { _key: 't3', label: '4"', valueInches: 4, addPrice: 5000 }], stackColor: '#BFE3C0', image: null, isRecommended: false, order: 2, isActive: false },
    { _id: 'mat-pure-latex-6', name: 'Pure Natural Latex (Firm)', slug: { current: 'pure-natural-latex-firm' }, slot: 'comfort', brand: 'RelaxPro Kerala Organic', density: '95 Density', ild: 'ILD-36', feelTag: 'Firm, supportive feel', benefit: 'High density GOLS certified latex for those who prefer a firmer surface with natural bounce.', tooltip: '95 Density Pure Dunlop Latex. ILD 36. GOLS certified. Maximum support from pure latex. Excellent for back sleepers.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 3000 }, { _key: 't2', label: '3"', valueInches: 3, addPrice: 4500 }, { _key: 't3', label: '4"', valueInches: 4, addPrice: 6000 }], stackColor: '#C9B99A', image: null, isRecommended: false, order: 3, isActive: false },
    { _id: 'mat-rebonded-firm', name: 'PU Rebonded Foam (Firm Support)', slug: { current: 'pu-rebonded' }, slot: 'support', brand: 'Century Foam', density: '90-95 Density', ild: 'ILD-45', feelTag: 'Rigid, orthopedic support', benefit: 'High density PU rebonded foam for maximum structural support. The rigid foundation keeps your spine aligned.', tooltip: 'Century brand PU rebonded foam. 90-95 Density. ILD 45. Zero sagging guarantee. 10+ year lifespan.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 3000 }, { _key: 't2', label: '4"', valueInches: 4, addPrice: 6000 }], stackColor: '#D4C5A9', image: null, isRecommended: true, order: 4, isActive: true },
    { _id: 'mat-hr-foam', name: 'HR Foam (Orthopedic Support)', slug: { current: 'hr-foam' }, slot: 'comfort', brand: 'Century Ortho HR', density: '60-70 Density', ild: 'ILD-38', feelTag: 'Firm, supportive middle layer', benefit: 'High-resilience foam that provides firm orthopedic support for the middle layer. Ideal for back sleepers needing extra lumbar support.', tooltip: 'Century HR Foam. 60-70 Density. ILD 38. High resilience orthopedic support foam. Excellent for spinal alignment.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 3000 }], stackColor: '#B8C5D6', image: null, isRecommended: true, order: 5, isActive: true },
    { _id: 'mat-hr-softy', name: 'HR Softy Foam (Plush Cushioning)', slug: { current: 'hr-softy-foam' }, slot: 'comfort', brand: 'Century AirFlow', density: '40-50 Density', ild: 'ILD-18', feelTag: 'Soft, plush transition comfort', benefit: 'High resilience softy foam that provides a plush, cushioning middle layer — perfect for pressure relief and side sleepers.', tooltip: 'Century HR Softy Foam. 40-50 Density. ILD 18. High resilience — bounces back instantly. Great for pressure relief.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 3000 }], stackColor: '#F0E6D3', image: null, isRecommended: false, order: 6, isActive: true },
    { _id: 'mat-latex-rebonded', name: 'Latex Rebonded Core (Eco)', slug: { current: 'latex-rebonded-core' }, slot: 'support', brand: 'RelaxPro Eco Core', density: '120 Density', ild: 'ILD-40', feelTag: 'Dense, eco-friendly support', benefit: 'Made from upcycled organic latex shreds compressed into a high-density core. Eco-friendly without compromising on support.', tooltip: '120 Density Latex Rebonded. ILD 40. Made from upcycled GOLS latex shreds. Eco-Institut certified. Zero waste manufacturing.', thicknessOptions: [{ _key: 't1', label: '2"', valueInches: 2, addPrice: 6000 }, { _key: 't2', label: '4"', valueInches: 4, addPrice: 12000 }], stackColor: '#A8C8A8', image: null, isRecommended: false, order: 7, isActive: true },
    // Consolidated Latex Foam — Natural Comfort step with 1/2/4/6/8" options
    { _id: 'mat-pure-latex-main', name: 'Latex Foam (Pure Natural)', slug: { current: 'pure-natural-latex' }, slot: 'comfort', brand: 'RelaxPro Kerala Organic', density: '90 Density', ild: 'ILD-28', feelTag: 'Responsive, breathable comfort', benefit: 'GOLS certified 90 density pure latex foam. Open-cell structure for natural cooling and pressure relief.', tooltip: '90 Density Pure Dunlop Latex. ILD 28. GOLS certified. Available in 1", 2", 4", 6", and 8" thicknesses.', thicknessOptions: [{ _key: 't0', label: '1"', valueInches: 1, addPrice: 6000 }, { _key: 't1', label: '2"', valueInches: 2, addPrice: 12000 }, { _key: 't2', label: '4"', valueInches: 4, addPrice: 24000 }, { _key: 't3', label: '6"', valueInches: 6, addPrice: 36000 }, { _key: 't4', label: '8"', valueInches: 8, addPrice: 48000 }], stackColor: '#BFE3C0', image: null, isRecommended: true, order: 8, isActive: true },
  ]
...
async function seedBuilderFabrics() {
  console.log('\n═══════ BUILDER FABRICS ═══════')
  const fabrics = [
    { _id: 'fabric-300gsm', name: '300 GSM Quilted Fabric (Standard)', slug: { current: 'fabric-300gsm' }, role: 'primaryCover', gsm: '300 GSM', quiltingMm: '8mm', benefit: 'Standard quilted fabric with OEKO-TEX certification. Breathable and durable for everyday use.', addPrice: 0, image: null, isRecommended: false, order: 1, isActive: false },
    ...
    { _id: 'quilting-8mm', name: '8mm Standard Quilting (Upgrade)', slug: { current: 'quilting-8mm' }, role: 'quiltingUpgrade', gsm: 'N/A', quiltingMm: '8mm', benefit: 'Standard 8mm quilting pattern for a classic mattress appearance.', addPrice: 0, image: null, isRecommended: false, order: 3, isActive: false },
...
function seedBuilderConfig() {
  ...
  return {
    ...
    defaults: { sizeName: 'Queen', comfortMaterialSlug: 'hr-foam', comfortThickness: 2, supportMaterialSlug: 'latex-rebonded-core', supportThickness: 4, coverFabricSlug: 'fabric-300gsm', quiltingSlug: 'quilting-12mm' },
