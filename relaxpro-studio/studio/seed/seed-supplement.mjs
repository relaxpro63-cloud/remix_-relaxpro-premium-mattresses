...
function seedBuilderConfig() {
  ...
  return {
    ...
    defaults: { sizeName: 'Queen', comfortMaterialSlug: 'pure-natural-latex-medium', comfortThickness: 2, supportMaterialSlug: 'latex-rebonded-core', supportThickness: 4, coverFabricSlug: 'fabric-300gsm', quiltingSlug: 'quilting-12mm' },
